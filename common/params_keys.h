...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Ev6DataGithubRepo", {PERSISTENT | BACKUP, STRING, "otaku13/ev6-driving-data"}},
    {"Ev6DataGithubToken", {PERSISTENT | DONT_LOG, STRING}},
    {"Ev6DataHashSalt", {PERSISTENT | DONT_LOG, STRING}},
    {"Ev6DataUploadEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"StopIntentAlert", {PERSISTENT | BACKUP, BOOL, "0"}},
